...
public class LaunchApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Let's learn language");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SelectUserType selectUserType = new SelectUserType();
        selectUserType.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaunchApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
